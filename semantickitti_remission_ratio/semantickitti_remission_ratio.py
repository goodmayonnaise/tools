...
class SemnaticKITTI(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        return {'X_rem':x_rem,'Y_rem':y_rem, 'x_check':x_cnt, 'y_check':y_cnt}
...
if __name__ == "__main__":
    ...
    for iter, batch in enumerate(data_loader):
        ...
        x_check.append(Variable(batch['x_check']).to(device))
        y_check.append(Variable(batch['y_check']).to(device))

    print('dataset lenght x ------------------------------------------------------')
    print(x_check)
    print(sum(x_check))
    print(len(x_check))
    print('average :', sum(x_check)/len(x_check))
    print('min :', min(x_check))
    print('max :', max(x_check))

    print('dataset lenght y ------------------------------------------------------')
    print(y_check)
    print(sum(y_check))
    print(len(y_check))
    print('average :', sum(y_check)/len(y_check))
    print('min :', min(y_check))
    print('max :', max(y_check))